        ...
        <nav id='navbar' className="navbar navbar-expand-sm px-1 navbar-dark py-3" style={{ background: 'black', color: 'white', zIndex: '1', position: 'sticky', top: '0' }}   >
            <div className="container-fluid">
                ...
                <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#collapsibleNavbar">
                    ...
                    <img className='rounded-circle ' style={{ width: '50px' }} src={maleProf ? Profile1 : Profile2} alt="profile" />
                </button>
                <div className="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
                    <ul className="navbar-nav">
                        ...
                        {window.innerWidth > 580 ? <img className='rounded-circle ' style={{ width: '50px' }} src={maleProf ? Profile1 : Profile2} alt="Profile" /> : null}
